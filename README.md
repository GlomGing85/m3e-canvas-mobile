...
Works with any AI coding tool that takes a prompt, such as Claude Code, Codex, Antigravity CLI or Cursor: copy the prompt, paste it into the tool, and ask for the app.
